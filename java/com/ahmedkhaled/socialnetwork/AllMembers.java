...
public class AllMembers extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        AndroidNetworking.get("http://178.62.119.179:5000/api/user/getAllusers")
                .setTag("getUsers")
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i<userCount; i++) {
                                ...
                                user.picture = "http://178.62.119.179:5000/"+arr.getJSONObject(i).getJSONObject("user").getString("profileImage");
...
class UserAdapter extends RecyclerView.Adapter<UserAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Picasso.get().load(user.getPicture()).placeholder(R.drawable.cpdefault).into(holder.userimage);
